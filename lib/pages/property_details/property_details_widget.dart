                            ...
                            Expanded(
                              child: Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 0.0, 24.0),
                                child: Text(
                                  '운영기간 : 2023.12.04 ~ 2023.12.17\n운영시간 : AM 10:30 ~ PM 20:30\n천진난만을 그리는 이슬로 작가의 특유 색감과 긍정적인 에너지를 담은 캐릭터, \'포코리프렌즈\'의 첫 대규모 팝업스토어가 더현대 서울에서 열립니다.',
                                  style: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                        fontFamily: 'Lexend Deca',
